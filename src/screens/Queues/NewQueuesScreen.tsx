...
// Example options (customize for Queues if needed)
const queuesTypeOptions: SelectOption[] = [
...
const relatedItems: RelatedItem[] = [
  ...
  { id: '2', title: 'Queue thread', subtitle: 'Last week' },
];
...
const NewQueuesScreen: React.FC = () => {
  ...
  const [queueType, setQueueType] = useState<string>('issue');
  ...
  return (
    <View style={themedStyles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={themedStyles.headerTitle}>New Queue</Text>
      </View>

      <View style={themedStyles.topCard}>
        <Text style={styles.topCardTitle}>New Queue</Text>
        <View style={styles.topRow}>
          <View style={styles.topCol}>
            <Text style={styles.topLabel}>Type</Text>
            <Text style={styles.topValue}>
              {queuesTypeOptions.find(o => o.id === queueType)?.label ?? '--'}
            </Text>
          </View>
          <View style={styles.topCol}>
        ...
        {activeTab === 'summary' ? (
          <View>
            ...
            <Accordion title="Queues">
              <SelectDropdown
                options={queuesTypeOptions}
                value={queueType}
                onChange={v => setQueueType(v || '')}
...
export default NewQueuesScreen;
