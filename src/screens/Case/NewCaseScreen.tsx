...
// Example options (customize for Case if needed)
...
const relatedItems: RelatedItem[] = [
  ...
  { id: '2', title: 'Case thread', subtitle: 'Last week' },
];
...
const NewCaseScreen: React.FC = () => {
  ...
  const [caseType, setCaseType] = useState<string>('issue');
  ...
  return (
    <View style={themedStyles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={themedStyles.headerTitle}>New Case</Text>
      </View>

      <View style={themedStyles.topCard}>
        <Text style={styles.topCardTitle}>New Case</Text>
        <View style={styles.topRow}>
          <View style={styles.topCol}>
            <Text style={styles.topLabel}>Type</Text>
            <Text style={styles.topValue}>
              {caseTypeOptions.find(o => o.id === caseType)?.label ?? '--'}
            </Text>
          </View>
          <View style={styles.topCol}>
