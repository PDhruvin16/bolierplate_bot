...
// Example options (customize for Price if needed)
...
const relatedItems: RelatedItem[] = [
  ...
  { id: '2', title: 'Price thread', subtitle: 'Last week' },
];
  ...
  return (
    <View style={themedStyles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={themedStyles.headerTitle}>New Price</Text>
      </View>

      <View style={themedStyles.topCard}>
        <Text style={styles.topCardTitle}>New Price</Text>
        <View style={styles.topRow}>
          <View style={styles.topCol}>
            <Text style={styles.topLabel}>Type</Text>
            <Text style={styles.topValue}>
              {priceTypeOptions.find(o => o.id === priceType)?.label ?? '--'}
            </Text>
          </View>
          <View style={styles.topCol}>
