...
// Example options (customize for Product if needed)
...
const relatedItems: RelatedItem[] = [
  ...
  { id: '2', title: 'Product thread', subtitle: 'Last week' },
];
...
const NewProductScreen: React.FC = () => {
  ...
  const [productType, setProductType] = useState<string>('hardware');
  ...
  return (
    <View style={themedStyles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={themedStyles.headerTitle}>New Product</Text>
      </View>

      <View style={themedStyles.topCard}>
        <Text style={styles.topCardTitle}>New Product</Text>
        <View style={styles.topRow}>
          <View style={styles.topCol}>
            <Text style={styles.topLabel}>Type</Text>
            <Text style={styles.topValue}>
              {productTypeOptions.find(o => o.id === productType)?.label ??
                '--'}
            </Text>
          </View>
          <View style={styles.topCol}>
