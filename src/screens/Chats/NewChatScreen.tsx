...
const chatTypeOptions: SelectOption[] = [
  ...
  return (
    <View style={themedStyles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={themedStyles.headerTitle}>New Chat</Text>
      </View>

      <View style={themedStyles.topCard}>
        <Text style={styles.topCardTitle}>New Chat</Text>
        <View style={styles.topRow}>
          <View style={styles.topCol}>
            <Text style={styles.topLabel}>Type</Text>
            <Text style={styles.topValue}>
              {chatTypeOptions.find(o => o.id === chatType)?.label ?? '--'}
            </Text>
          </View>
          <View style={styles.topCol}>
