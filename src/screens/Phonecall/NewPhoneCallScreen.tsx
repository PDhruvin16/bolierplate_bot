...
const phoneCallTypeOptions: SelectOption[] = [
...
const NewPhoneCallScreen: React.FC = () => {
  ...
  const [phoneCallType, setPhoneCallType] = useState<string>('incoming');
  ...
  return (
    <View style={themedStyles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={themedStyles.headerTitle}>New Phone Call</Text>
      </View>

      <View style={themedStyles.topCard}>
        <Text style={styles.topCardTitle}>New Phone Call</Text>
        <View style={styles.topRow}>
          <View style={styles.topCol}>
            <Text style={styles.topLabel}>Type</Text>
            <Text style={styles.topValue}>
              {phoneCallTypeOptions.find(o => o.id === phoneCallType)?.label ??
                '--'}
            </Text>
          </View>
          <View style={styles.topCol}>
        ...
        {activeTab === 'summary' ? (
          <View>
            ...
            <Accordion title="Phone Call">
              <SelectDropdown
                options={phoneCallTypeOptions}
                value={phoneCallType}
                onChange={v => setPhoneCallType(v || '')}
...
export default NewPhoneCallScreen;
